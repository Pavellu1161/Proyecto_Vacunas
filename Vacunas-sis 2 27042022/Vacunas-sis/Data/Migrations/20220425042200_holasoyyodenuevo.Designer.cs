...
namespace Vacunas_sis.Data.Migrations
{
    ...
    [Migration("20220425042200_holasoyyodenuevo")]
    partial class holasoyyodenuevo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vacunas_sis.Models.Detalle_Vacuna", b =>
                {
                    b.Property<int>("Id_detalle_vacuna")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("Fecha_proxima_dosis")
                        .HasColumnType("datetime2");

                    b.Property<int>("Id_vacuna")
                        .HasColumnType("int");

                    b.Property<string>("Numero_dosis_aplicada")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Numero_dosis_restantes")
                        .HasColumnType("int");

                    b.HasKey("Id_detalle_vacuna");

                    b.HasIndex("Id_vacuna");

                    b.ToTable("Detalle_Vacuna");
                });

            modelBuilder.Entity("Vacunas_sis.Models.Direccion", b =>
                {
            ...
            modelBuilder.Entity("Vacunas_sis.Models.Informacion_nino", b =>
                {
                    ...
                    b.ToTable("Informacion_nino");
                });

            modelBuilder.Entity("Vacunas_sis.Models.Registro", b =>
                {
                    ...
                    b.Property<string>("Numero_historia")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id_registro");

                    b.HasIndex("Id_detalle_vacuna");
            ...
            modelBuilder.Entity("Vacunas_sis.Models.Registro", b =>
                {
                    b.HasOne("Vacunas_sis.Models.Detalle_Vacuna", "Detalles")
                        .WithMany("Registros")
                        .HasForeignKey("Id_detalle_vacuna")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
