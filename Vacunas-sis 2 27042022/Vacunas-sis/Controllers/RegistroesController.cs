...
namespace Vacunas_sis.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        {
            ViewData["Id_detalle_vacuna"] = new SelectList(_context.Detalle_Vacuna, "Id_detalle_vacuna", "Fecha_aplicacion", "Numero_dosis_aplicada");
            ViewData["Id_nino"] = new SelectList(_context.Informacion_nino, "Id_nino", "Numero_identidad");
            return View();
        }
